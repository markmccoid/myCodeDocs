...
[codecademy Course on Regex](https://www.codecademy.com/courses/introduction-to-regular-expressions/lessons/nlp-regex-conceptual/exercises/literals)
...
Remember, within any character set `[]` we only match *one* character.## Shorthand Character Classes*
